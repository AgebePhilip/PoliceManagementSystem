...
@section('content')
    <div class="single-report-admit">
        <div class="card-header">
            <h2 class="text-center text-uppercase color-whitesmoke" >{{ __('service::install.license_verification') }} | <a style="color:red;" href="https:/ThemePlugin.Info"" target="_blank">ThemePlugin.Info"</a>
            </h2>
